...
# -*- coding: utf-8 -*-
#
# pathds documentation build configuration file, created by
...
project = u'GenomicsDB Python API'
copyright = u"2020, Omics Data Automation"
author = u"Kevin Matlock"
...
htmlhelp_basename = 'genomicsdb_pythondoc'
...
latex_elements = {
    ...
    'maketitle': r'''
        ...
        \begin{titlepage}
            ...
            \textbf{\Huge {GenomicsDB Python API}}
...
latex_documents = [
    (master_doc, 'genomicsdb_python.tex',
     u'GenomicsDB Python API Documentation',
     u'Omics Data Automation', 
     'manual'),
]
...
texinfo_documents = [
    (master_doc, 'genomicsdb_python',
     ...
     author,
     'genomicsdb_python',
     'Python API for Genomics Data Store.',
     'Miscellaneous'),
]
